...
public class CustomProgressToast {
    ...
    private static FrameLayout bar;
    private WindowManager mWM;
    private final WindowManager.LayoutParams mParams = new WindowManager.LayoutParams();

    public static CustomProgressToast makeText(Context context, int time) {
        CustomProgressToast result = new CustomProgressToast(context);
        View view = LinearLayout.inflate(context, R.layout.item_progress, null);
        bar=(FrameLayout) view.findViewById(R.id.progressBar);
